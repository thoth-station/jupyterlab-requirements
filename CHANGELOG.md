...
* Create FUNDING.yml
* Release of version 0.6.5 (#265)
* :arrow_up: Automatic update of dependencies by Kebechet (#264)
* :arrow_up: Automatic update of dependencies by Kebechet (#262)
* Release of version 0.6.4 (#259)
...
* Release of version 0.4.1 (#149)
* Fix missing depndency (#146)
* Release of version 0.4.0 (#144)
...
* Release of version 0.3.7 (#122)
* Release of version 0.3.6 (#119)
...
* Add missing paremeters to setup.py (#108)
* Adjust server extension entry paths (#106)
* :arrow_up: Automatic update of dependencies by Kebechet (#105)
* :arrow_up: Automatic update of dependencies by Kebechet (#104)
* Improve description about adding packages (#103)
* Adjust images links (#102)
* Introduce docs and steps on how to use the current version on the extension (#101)
* Release of version 0.3.0 (#100)
...
* Enforce consitency for handlers (#88)
* Adjust name package (#86)
* Adjust installation path (#85)
* Release v0.2.1 (#84)
* Adjust installation after thoth advise (#83)
* adjust-installation (#82)
* Capture output to show info (#78)
* Add description in README (#74)
* Allow user to select recommendation type for thoth advise (#67)
* Add get_origin method (#60)
* Adjust for release 0.1.1 (#59)
* Adjust configuration file for installation (#57)
* Adjust thamos advise (#56)
* Adjust virtual environment paths (#55)
* Adjust method to retrieve kernelspec from notebook (#54)
* Release of version 0.0.2 (#49)
* Initial UI (#42)
...
* Add check=True to raise exception when subprocess fails (#71)
...
* Allow server discover (#107)
* minor adjustments for consistency (#97)
* Automatic relock when user delete package and save (#73)
* Move to Jupyterlab3 and remove pre releases (#72)
...
* installation and js
### Non-functional
* Adjust logic, refactor code and improve UI (#61)
### Other
